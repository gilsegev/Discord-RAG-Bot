...
assert.match(planner, /complete_production_embeddings/);
assert.match(planner, /observed embedding model\/version mismatch/);
assert.doesNotMatch(planner, /fixture_attestation|deterministic_replan/);
